    ...
    async function fetchUser() {
      try {
        ...
        setUserData({
          ...
          full_name:
            user.user_metadata?.full_name ?? profile?.full_name ?? null,
          avatar_url:
      ...
      >
        ...
        >
          ...
          >
            <InfoItem
              icon={<User size={16} />}
              label="Member Since"
              value={userData?.member_since ?? "N/A"}
            />
            <InfoItem
              icon={<Wallet size={16} />}
              label="Account Type"
              value={userData?.account_type ?? "Standard"}
            />
            <InfoItem
              icon={<Shield size={16} />}
              label="Status"
        ...
        >
          ...
          <MetricCard
            ...
            value={
              userData?.monthly_spending != null
                ? `$${userData?.monthly_spending}`
                : "N/A"
            }
            trend="%"
            trendUp={false}
          ...
          <MetricCard
            ...
            icon={<Target size={20} />}
            value={
              userData?.savings_progress != null
                ? `$${userData?.savings_progress} / $12,500`
                : "N/A"
            }
            trend="%"
            trendUp
            ...
            progress={
              userData?.savings_progress != null
                ? (userData?.savings_progress / 12500) * 100
                : undefined
            }
          />
          ...
          <MetricCard
            ...
            value={
              userData?.investment != null ? `$${userData?.investment}` : "N/A"
            }
            trend="%"
            trendUp
            color="#10b981"
...
// — Helper components (InfoItem, MetricCard, etc.) remain unchanged —
// Copy all your previous helper components below (InfoItem, MetricCard, Section, InputField, ToggleSetting, ActionButton)
